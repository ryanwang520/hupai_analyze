const Jul2022 = [
  [2022, 7],
  [
    90500, 90500, 90500, 90500, 90600, 90800, 90800, 90800, 90900, 91100, 91100,
    91100, 91200, 91200, 91300, 91300,
  ],
  [
    91100, 91100, 91100, 91100, 91200, 91400, 91400, 91400, 91500, 91600, 91700,
    91700, 91800, 91800, 91900, 91900,
  ],
  {
    min: 91700,
    avg: 91786,
...
const Jun2022 = [
  [2022, 6],
  [
    90800, 90900, 91100, 91200, 91200, 91200, 91200, 91200, 91200, 91200, 91200,
    91200, 91300, 91300, 91500,
  ],
  [
    91400, 91500, 91700, 91800, 91800, 91800, 91800, 91800, 91800, 91800, 91800,
    91800, 91900, 91900, 92100,
  ],
  {
    min: 91800,
    avg: 91926,
...
const May2022 = [
  [2022, 5],
  [
    91300, 91400, 91500, 91500, 91500, 91600, 91600, 91600, 91600, 91600, 91600,
    91700, 91800, 92000, 92000,
  ],
  [
    91900, 92000, 92100, 92100, 92100, 92200, 92200, 92200, 92200, 92200, 92200,
    92300, 92400, 92600, 92600,
  ],
  {
    min: 92400,
    avg: 92527,
...
const April2022 = [
  [2022, 4],
  [
    91200, 91300, 91400, 91500, 91500, 91500, 91500, 91600, 91600, 91600, 91700,
    91700, 91900, 92000, 92100,
  ],
  [
    91800, 91900, 92000, 92100, 92100, 92100, 92100, 92200, 92200, 92200, 92300,
    92300, 92500, 92600, 92700,
  ],
  {
    min: 92500,
    avg: 92573,
...
const March2022 = [
  [2022, 3],
  [
    91100, 91200, 91300, 91400, 91500, 91600, 91700, 91800, 91900, 92000, 92100,
    92200, 92300, 92300, 92400,
  ],
  [
    91700, 91800, 91900, 92000, 92100, 92200, 92300, 92400, 92500, 92600, 92700,
    92800, 92900, 92900, 93000,
  ],
  {
    min: 92700,
    avg: 92750,
...
const Feb2022 = [
  [2022, 2],
  [
    91600, 91700, 91800, 91900, 91900, 91900, 91900, 92000, 92000, 92000, 92100,
    92100, 92300, 92300, 92400,
  ],
  [
    92200, 92300, 92400, 92500, 92500, 92500, 92500, 92600, 92600, 92600, 92700,
    92700, 92900, 92900, 93000,
  ],
  {
    min: 92700,
    avg: 92860,
